CREATE TABLE UserData (
	...
	MobileNo INT NOT NULL CONSTRAINT USER_MOBILE CHECK (MobileNo BETWEEN 1000000000 AND 9999999999),
...
ALTER TABLE Post WITH CHECK ADD CONSTRAINT FK_ContributionType FOREIGN KEY(ContributionTypeId) REFERENCES ContributionType(ContributionTypeId)
...
CREATE TABLE Roles (
	...
	RoleType NVARCHAR(50) NOT NULL, --Admin,Volunteer,Organisation,User
	UserId BIGINT NOT NULL,
...
ALTER TABLE Roles WITH CHECK ADD CONSTRAINT FK_Module FOREIGN KEY(ModuleId) REFERENCES Module(ModuleId)
...
CREATE TABLE Organisation (
    ...
    OrganisationContactNo INT NOT NULL CONSTRAINT ORGANISATION_MOBILE CHECK (OrganisationContactNo BETWEEN 1000000000 AND 9999999999),
...
CREATE TABLE ContributionType (
    ContributionTypeId BIGINT IDENTITY(1,1) CONSTRAINT PK_Contro PRIMARY KEY,
    ContributionTypeName NVARCHAR(50) NOT NULL,
	CreatedBy NVARCHAR(50) NOT NULL, 
    CreatedAt DATETIME NOT NULL, 
    UpdatedBy NVARCHAR(50) NOT NULL, 
    UpdatedAt DATETIME NOT NULL
...
ALTER TABLE ClusterLocations WITH CHECK ADD CONSTRAINT FK_ClusterControId FOREIGN KEY(ContributionTypeId) REFERENCES ContributionType(ContributionTypeId)
